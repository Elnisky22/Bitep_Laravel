		...
		<div id="mySlide">
			<div id="slideshow" class="w3-display-container flex-wrap">
				@foreach ($imagens as $i)
					<img class="petImg" src="data:image/{{$i->extencao}};base64,{{ base64_encode($i->imagem) }}" width="600px" height="400px" alt="Ocorreu um erro ao carregar a imagem.">
				@endforeach
			</div>
			<div class="grid-container flex-wrap">
				<div class="grid-item">
