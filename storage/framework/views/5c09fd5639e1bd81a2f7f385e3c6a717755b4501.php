...
<head>
	...
	<!-- CSS da Página -->
	<link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/editarPerfil.css')); ?>"/>
</head>
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\Bitep_Laravel\resources\views/editarPerfil.blade.php ENDPATH**/ ?>